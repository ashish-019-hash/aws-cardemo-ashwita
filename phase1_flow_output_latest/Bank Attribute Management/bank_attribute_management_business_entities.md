...
- Business Rule BR-001: "Bank must exist in the system before attributes can be created for it"
...
**Relevance to User Story:**
- Controls access to all bank attribute operations (BR-003: Role-Based Access Control)
...
|---------------|----------------|------------------|
| BR-001: Bank Existence Prerequisite | MappedBank | BankAttribute |
| BR-002: Attribute Type Validation | BankAttribute | - |
| BR-003: Role-Based Access Control | MappedEntitlement | ResourceUser |
| BR-004: Attribute Name Length Constraint | BankAttribute | - |
| BR-005: Attribute Value Length Constraint | BankAttribute | - |
| BR-006: Active Status Default Value | BankAttribute | - |
| BR-007: Unique Attribute ID Generation | BankAttribute | - |
| BR-008: Attribute Definition Management | AttributeDefinition | MappedBank |
