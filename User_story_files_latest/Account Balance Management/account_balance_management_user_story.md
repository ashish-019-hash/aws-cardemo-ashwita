...
Note: While the codebase contains GET endpoints for retrieving balance records (getBankAccountBalanceById, getAllBankAccountBalances), these are NOT included in this user story because the capability description specifically states "Create, update, and delete" without mentioning retrieval operations. Retrieval operations would fall under a separate "Account Balance Retrieval" capability.
