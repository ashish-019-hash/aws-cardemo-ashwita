...
- [x] Business value is stated (display account info, enable account selection, aggregate accounts, provide financial services)
...
- [x] No CRUD operations are inferred beyond what the description explicitly states (only "Retrieve" and "list" mentioned)
